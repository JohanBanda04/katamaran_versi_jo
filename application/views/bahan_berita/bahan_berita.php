    ...
    <div id="mainContent" class="" >
        ...
        <form action="<?php echo $link1; ?>/v/f.html"
            ...
            <div class="row justify-content-center p-15">
                <h2 class="m-0 font-weight-bold">Bahan Beritaa</h2>
...
<!--                    </button>-->
                    ...
                    <button type="button"
                        ...
                        <span class="bg-float"></span>
                        <span class="text">Tambah Bahan Beritaz</span>
                    </button>
                </div>
...
<!--                                <td style="text-align: center">Pekan --><?php //echo $this->Mcrud->weekOfMonth(strtotime($dt['tanggal'])) . " ";?><!--</td>-->
                                <td style="text-align: center">
                                    <?php echo $this->Mcrud->hari_id($dt['tanggal']); ?> / <?php echo $this->Mcrud->tgl_english($dt['tanggal'], 'full'); ?>
                                </td>
<!--                                <td style="text-align: center">-->
